...
bool CBattleGame::StartTCP(int port)
{
	...
	if (WSAStartup(MAKEWORD(16, 16), &wsaData))
	{
...
{
	thread RT(&CBattlePlayer::PrepareShips, &m_Player2);
	//thread FR(&CBattlePlayer::PrepareShips, &m_Player1);
